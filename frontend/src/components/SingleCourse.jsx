...
const SingleCoursePage = () => {
  ...
  return (
    <SingleCourseWrapper>
      <div className="grid mx-auto course-intro">
        <div className="course-img">
          <img src={image} alt={course_name} />
        </div>
        <div className="course-details">
          <div className="bg-white course-category text-dark text-capitalize fw-6 fs-12 d-inline-block">
            {category}
          </div>
          ...
          <div className="course-body">
            ...
            <div className="flex course-rating">
      ...
      <div className="bg-white course-full text-dark">
        <div className="mx-auto course-learn">
          <div className="course-sc-title">What you'll learn</div>
          <ul className="grid course-learn-list">
            {learnItems &&
        ...
        <div className="mx-auto course-content">
