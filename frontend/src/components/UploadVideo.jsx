                ...
                <div key={index} className="mb-4">
                  ...
                  {index > 0 && (
                    <button
                      ...
                      className="px-4 py-2 my-5 ml-2 font-semibold transition-colors bg-white border rounded cursor-pointer hover:bg-slate-800 hover:text-white text-slate-800 border-slate-800 float-start"
                    >
                      Remove
                    </button>
                  )}
